...
\subsection{Q2 - Dataset B}\label{subsec:dataset-b}
    ...
    \begin{subfigure}{0.9\textwidth}
      ...
      \caption{\inlinecode{B_NoiseAdded.csv} after pre-processing, no missing labels or duplicated observations remaining.
    ...
    Fig.\eqref{fig:q2a} summarises the classifications for the raw \inlinecode{B_NoiseAdded.csv} dataset.
