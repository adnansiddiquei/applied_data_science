...
\subsubsection{Question 5a}\label{subsubsec:q5a}
    ...
    \caption{The cost functions for the K-Means and Gaussian Mixture Models as \inlinecode{n_init} is increased
    ...
    The dataset \inlinecode{ADS_baselineDataset.csv} underwent identical pre-processing as for Q4 and Q3e, followed by
...
\subsubsection{Question 5b}\label{subsubsec:q5b}
    ...
    A \inlinecode{LogisticRegression} classifier was applied to the data in Fig. \eqref{fig:q5a_contingency_table} to
